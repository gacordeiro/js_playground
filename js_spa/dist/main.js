...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"eventoEnvia\": () => /* binding */ eventoEnvia\n/* harmony export */ });\n/* harmony import */ var _api_cliente_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../api/cliente.js */ \"./src/api/cliente.js\");\n/* harmony import */ var _valida_validaCPF_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../valida/validaCPF.js */ \"./src/componentes/valida/validaCPF.js\");\n/* harmony import */ var _alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../alerta/componente-alerta.js */ \"./src/componentes/alerta/componente-alerta.js\");\n\n\n\n\nconst eventoEnvia = (form) => form.addEventListener('submit', event => {\n  event.preventDefault();\n\n  const nome = event.target.querySelector('[data-nome]').value;\n  const cpf = event.target.querySelector('[data-cpf]').value;\n\n  if ((0,_valida_validaCPF_js__WEBPACK_IMPORTED_MODULE_1__.validaCPF)(cpf)) {\n    (0,_api_cliente_js__WEBPACK_IMPORTED_MODULE_0__.cadastrarClientes)(nome, cpf).then(() =>\n        (0,_alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__.alerta)(form, 'alert alert-success', 'CLIENTE CRIADO COM SUCESSO !'),\n    ).catch(() =>\n        (0,_alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__.alerta)(form, 'alert alert-warning', 'O CLIENTE NÃO PODE SER CRIADO !'),\n    );\n  } else {\n    alert('O CPF não é válido');\n  }\n});\n\n\n\n//# sourceURL=webpack://js_spa/./src/componentes/cadastro/cadastro-clientes.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _api_cliente_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../api/cliente.js */ \"./src/api/cliente.js\");\n/* harmony import */ var _valida_validaCPF_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../valida/validaCPF.js */ \"./src/componentes/valida/validaCPF.js\");\n/* harmony import */ var _alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../alerta/componente-alerta.js */ \"./src/componentes/alerta/componente-alerta.js\");\n\n\n\n\nconst eventoForm = (form) => {\n  const pegaURL = new URL(window.location);\n\n  const id = pegaURL.searchParams.get('id');\n\n  const inputCPF = form.querySelector('[data-cpf]');\n  const inputNome = form.querySelector('[data-nome]');\n\n  (0,_api_cliente_js__WEBPACK_IMPORTED_MODULE_0__.detalhaCliente)(id).then(dados => {\n    inputCPF.value = dados[0].cpf;\n    inputNome.value = dados[0].nome;\n  });\n\n  form.addEventListener('submit', event => {\n    event.preventDefault();\n\n    if (!(0,_valida_validaCPF_js__WEBPACK_IMPORTED_MODULE_1__.validaCPF)(inputCPF.value)) {\n      alert('ESSE CPF NÃO EXISTE');\n      return;\n    }\n\n    (0,_api_cliente_js__WEBPACK_IMPORTED_MODULE_0__.editaCliente)(id, inputCPF.value, inputNome.value).then(() =>\n        (0,_alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__.alerta)(form, 'alert alert-success', 'CLIENTE EDITADO COM SUCESSO !'),\n    ).catch(() =>\n        (0,_alerta_componente_alerta_js__WEBPACK_IMPORTED_MODULE_2__.alerta)(form, 'alert alert-warning', 'O CLIENTE NÃO PODE SER EDITADO !'),\n    );\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (eventoForm);\n\n\n//# sourceURL=webpack://js_spa/./src/componentes/edita/edita-cliente.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _edita_cliente_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edita-cliente.js */ \"./src/componentes/edita/edita-cliente.js\");\n\n\nconst inicializaFormEdicao = () => {\n  const form = document.createElement('form');\n  form.innerHTML = `\n  <div class=\"container\">\n    <div class=\"form-group\">\n      <label>CPF</label>\n      <input type=\"number\" class=\"form-control\" data-cpf placeholder=\"Digite seu CPF aqui\" />\n    </div>\n    <div class=\"form-group\">\n      <label>Nome</label>\n      <input type=\"text\" class=\"form-control\" data-nome placeholder=\"Digite seu nome aqui\" />\n    </div>\n    <div data-sucesso></div>\n    <button type=\"submit\" class=\"btn btn-primary\">Enviar</button>\n  </div>`;\n\n  (0,_edita_cliente_js__WEBPACK_IMPORTED_MODULE_0__.default)(form);\n  return form;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (inicializaFormEdicao);\n\n\n//# sourceURL=webpack://js_spa/./src/componentes/edita/form-edicao.js?");
